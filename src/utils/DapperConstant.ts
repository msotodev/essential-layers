export const DAPPER_CONFIGURE = `app.Services.ConfigureDapper("YOUR_CONNECTION_STRING");`;

export const DAPPER_PROCEDURE_DEFINITIONS = `ResultHelper<TResult> Execute<TResult, TRequest>(
...
export const DAPPER_QUERY_DEFINITIONS = `ResultHelper<HashSet<ResultDto>> QueryAll<ResultDto>(
